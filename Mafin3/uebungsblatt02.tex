...
\section*{Aufgabe 2}
\subsection*{(i)}
\[\int_0^{log2} x^2e^x \,dx\]
\[=[x^2e^x]_0^{log2}-\int_0^{log2}e^x*2x\,dx\]
\[=[x^2e^x]_0^{log2}-[2x*e^x]_0^{log2}- \int_0^{log2}e^x*2\,dx\]
\[=[x^2e^x]_0^{log2}-[2x*e^x]_0^{log2}- 2\int_0^{log2}e^x\,dx\]
\[=[x^2e^x]_0^{log2}-[2x*e^x]_0^{log2}- 2[e^x]_0^{log2}\]
\[=log2^2e^{log2}-0^2*e^0-2(log(2))*e^{log2}- 2*0*e^0- 2(e^{log2})-2(e^0)\]
\[=log2^2e^{log2}-2(log(2))*e^{log2}- 2(e^{log2})-2\]
\[=log2^2*2-2(log(2))*2- 2*2-2\]
\[=2log2*2-2log(2)*2- 6\]
\[=-6\]
\subsection*{(ii)}
...
\[=\frac{1}{2}([\frac{x-sin(2x)}{2}]_0^\pi)\]
\[=\frac{1}{2}(\pi-\frac{sin(2\pi)}{2})-\frac{1}{2}(0-sin(2*0))\]
\[=\frac{1}{2}(\pi-\frac{sin(2\pi)}{2})\]
\[=\frac{1}{2}(\pi-0)\]
\[=\frac{\pi}{2}\]

\subsection*{(iii)}
\[\int_1^e \sqrt{x}\,logx \,dx\]
\[=[\frac{2}{3}x^{\frac{3}{2}} logx]_1^e - \int_1^e\frac{2}{3}x^{\frac{3}{2}}*\frac{1}x{}\,dx\]
\[=[\frac{2}{3}x^{\frac{3}{2}} logx]_1^e - \frac{2}{3}\int_1^ex^{\frac{3}{2}}*\frac{1}x{}\,dx\]
\[=[\frac{2}{3}x^{\frac{3}{2}} logx]_1^e - \frac{2}{3}\int_1^ex^{\frac{1}{2}}\]
\[=[\frac{2}{3}x^{\frac{3}{2}} logx]_1^e-[\frac{2}{3}*\frac{2}{3}x^{\frac{3}{2}}]_1^e\]
\[=\frac{2}{3}e^{\frac{3}{2}} loge-\frac{2}{3}*\frac{2}{3}e^{\frac{3}{2}}(-\frac{2}{3}*1^{\frac{3}{2}} log1-\frac{2}{3}*\frac{2}{3}*1^{\frac{3}{2}})\]
\[=\frac{2}{3}e^{\frac{3}{2}}-\frac{4}{9}e^{\frac{3}{2}}-(0-\frac{4}{9})\]
\[=\frac{2}{9}e^{\frac{2}{3}}-(-\frac{4}{9})\]
\[=\frac{2}{9}e^{\frac{2}{3}}+\frac{4}{9}\]

\section*{Aufgabe 3}
\subsection*{(i)}
Substition: $u=x^2\,\, \\u'=2x=\frac{du}{dx}$ somit $du=2xdx$ oder $xdx=\frac{1}{2}du$
\[\int_0^2xe^{x^2} \,dx\]
Grenzen: $2^2=4,\; 0^2=0$
\[=\int_0^4e^u\frac{1}{2} \,du\]
\[=\frac{1}{2}\int_0^4e^u \,du\]
\[=\frac{1}{2}(e^4-e^0)\]
